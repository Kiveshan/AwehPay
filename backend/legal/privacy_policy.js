...
// Required by Google Play's "App content" > Privacy Policy declaration: a public URL
// describing the app's data practices. Mirrors the content already shown in-app at
// lib/src/features/Registration/views/privacy_policy_screen.dart, kept in sync manually.
router.get('/', (req, res) => {
...
<head>
  ...
  <title>AwehBiz Privacy Policy</title>
  <style>
    body { font-family: -apple-system, Segoe UI, Roboto, Arial, sans-serif; max-width: 760px; margin: 48px auto; padding: 0 20px; color: #272A2F; line-height: 1.6; }
    h1 { font-size: 26px; margin-bottom: 4px; }
    .updated { color: #6C7078; font-size: 14px; margin-bottom: 32px; }
...
<body>
  ...
  <p>AwehBiz is a cloud-based mobile application designed for small traders to manage Point of Sale (POS), Inventory Control, and Analytics. We use Your Personal Data to provide and improve this Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.</p>

  <h2>Interpretation and Definitions</h2>
  <p><strong>Interpretation</strong><br>The words whose initial letters are capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
  ...
  <ul>
    ...
    <li><strong>Application</strong> refers to AwehBiz, the software program provided by the Company.</li>
    <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to SmartBuilders (Pty) Ltd, 63 Ilchester Avenue, Somerset Park Umhlanga, 4319.</li>
  ...
  <ul>
    ...
    <li>Bank Account Number and Banking Details (collected to set up payment processing and to verify business legitimacy).</li>
  </ul>
  <p><strong>Usage Data</strong><br>Usage Data is collected automatically when using the Service.
  ...
  <p><strong>Information Collected while Using the Application</strong><br>While using Our Application, in order to provide features of Our Application, We may collect, with Your prior permission:</p>
  <ul>
    <li>Pictures and other information from your Device's camera and photo library (e.g., for scanning barcodes, scanning invoices/receipts, or uploading product images).</li>
  </ul>
  ...
  <ul>
    ...
    <li>To prevent misuse of services: We collect and process banking details and business information to verify the identity of businesses and to ensure that users do not abuse the 30-day free trial period or violate our Terms of Service.</li>
  </ul>
  ...
  <p>You have the right to delete or request that We assist in deleting Your Personal Data that We have collected about You.</p>
  <p>Our Service may give You the ability to delete certain information about You from within the Service.</p>
  <p>You may update, amend, or delete Your information at any time by signing in to Your Account, if you have one, and visiting the account settings section that allows you to manage Your personal information. You may also contact Us to request access to, correct, or delete any Personal Data that You have provided to Us — see <a href="/delete-account">our account deletion page</a>.</p>
  <p>Please note, however, that We may need to retain certain information when we have a legal obligation or lawful basis to do so.</p>

  <h2>Disclosure of Your Personal Data</h2>
  <p><strong>Business Transactions</strong><br>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
  <p><strong>Law enforcement</strong><br>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
  <p><strong>Other legal requirements</strong><br>The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
  <ul>
  ...
  <h2>Service Plans and Features</h2>
  <p>The AwehBiz Application offers two primary service plans: Basic and Premium.</p>
  <ul>
    <li>Basic Plan (R300 p/m): Setup is free. Features include Barcode Scanner Access, Low-stock Alerts, Cash Sales, up to 50 Card Payments Daily, Net Profit + Analytics, up to 100 Products, and 15 Services.</li>
    <li>Premium Plan (R500 p/m): Setup is free. Features include Barcode Scanner Access, Unlimited Card Payments, Daily Breakdown of Products Sold, Full Insights, Unlimited Fixed Expenses, and Unlimited Products and Services. A 30-day free trial of the Premium Tier is available to all new users.</li>
  </ul>
  <p>We may collect and verify Your banking details and business information to authenticate Your business, set up payment processing for card transactions, and to prevent the misuse of the 30-day free trial and other promotional offers.</p>
  ...
  <ul>
    <li>By email: <a href="mailto:info@smart-builders.co.za">info@smart-builders.co.za</a></li>
    <li>By visiting this page on our website: <a href="https://www.smart-builders.co.za/">https://www.smart-builders.co.za/</a></li>
  </ul>
</body>
</html>`);
});
